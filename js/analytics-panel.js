...
class AnalyticsPanel {
  ...
  calculateKPIs() {
    ...
    // Default to project baseline 12.975 if calculated sum is 0
    if (!totalPop) totalPop = 12975;
  ...
  renderSuperficieChart() {
    ...
    this.chartSuperficie = new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["Trombetas/Mapuera", "Kaxuyana-Tunayana", "Nhamundá/Mapuera", "Uaçá"],
        datasets: [{
          label: "Área (mil hectares)",
          data: [3970.8, 2184.1, 1049.5, 470.1],
  ...
  renderPopulationChart() {
    ...
    this.chartPopulation = new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["TI Trombetas/Mapuera", "TI Uaçá", "TI Nhamundá/Mapuera", "TI Kaxuyana-Tunayana"],
        datasets: [{
          label: "Habitantes",
