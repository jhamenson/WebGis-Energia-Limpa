...
function cleanAccents(str) {
  ...
  const exactMojibake = {
    ...
    "PRACUÃBA": "PRACUÚBA",
    "CARACARAÃ": "CARACARAÍ",
    "NOVO AIRÃO": "NOVO AIRÃO",
    "RORAINÃPOLIS": "RORAINÓPOLIS",
    "SÃO GABRIEL DA CACHOEIRA": "SÃO GABRIEL DA CACHOEIRA",
    "SÃO JOÃO DA BALIZA": "SÃO JOÃO DA BALIZA",
    "SÃO LUIZ DO ANAUÃ": "SÃO LUIZ DO ANAUÁ",
    "SÃO MIGUEL DO GUAPORÃ": "SÃO MIGUEL DO GUAPORÉ",
    "SÃO PAULO DE OLIVENÃA": "SÃO PAULO DE OLIVENÇA",
    "SÃO SEBASTIÃO DO UATUMÃ": "SÃO SEBASTIÃO DO UATUMÃ",
    "SÃO VICENTE DE CHIQUINHO": "SÃO VICENTE DE CHIQUINHO",
    "Terra da UniÃ£o": "Terra da União",
    "Terra da UniÃo": "Terra da União",
    "ConservaÃ§Ã£o": "Conservação",
    "ConservaÃ§ao": "Conservação",
    "ConservaÃ§Ãµes": "Conservações",
    "ConservaÃ§oes": "Conservações",
    "ConservaÃ§Ã£o": "Conservação",
    "ConservaÃ§ao": "Conservação"
  };
